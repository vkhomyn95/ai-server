...
class SpeechToTextStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Recognize = channel.unary_unary(
                '/voiptime.cloud.stt.v1.SpeechToText/Recognize',
        ...
        self.StreamingRecognize = channel.stream_stream(
                '/voiptime.cloud.stt.v1.SpeechToText/StreamingRecognize',
...
def add_SpeechToTextServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'voiptime.cloud.stt.v1.SpeechToText', rpc_method_handlers)
...
class SpeechToText(object):
    ...
    def Recognize(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/voiptime.cloud.stt.v1.SpeechToText/Recognize',
    ...
    def StreamingRecognize(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/voiptime.cloud.stt.v1.SpeechToText/StreamingRecognize',
